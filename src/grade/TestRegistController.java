...
public class TestRegistController extends CommonServlet {
	...
	protected void get(HttpServletRequest req, HttpServletResponse resp) throws Exception {
	    ...
	    try {
	        ...
	        cn_list.sort(Comparator.comparing(ClassNum::getClass_num));
	        req.setAttribute("classNums", cn_list);
	            ...
	            if (f1 != null && !f1.isEmpty()
	             ...
	             && f4 != null && !f4.isEmpty()) {
	                ...
	                try {
	                   ...
	                   e.printStackTrace(); // エラーはログに出力する
	                   errorMsgs.add("データの取得中にエラーが発生しました。");
	                }

	            } else {
	               // 検索ボタンは押されたが、未入力項目がある場合
